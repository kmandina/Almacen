...
class ListProdsForSellAdapter(
    val id: Long,
    val viewmodel: SellViewModel,
    val viewmodelP: ProductViewModel,
    val nav: NavController
) : ListAdapter<Product, RecyclerView.ViewHolder>(ListProdForSellDiffCallback()) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            holder.binding.product?.let { item ->

                val d = Dialog( holder.binding.root.context)
                ...
                fun Validador(): Boolean {
                    ...
                    if (amount.text.toString().isEmpty()) {
                        ...
                        Toast.makeText(
                            ...
                            holder.binding.root.context.getString(R.string.alert_empty_amount),
                            Toast.LENGTH_SHORT
                        ).show()
                        ...
                        Toast.makeText(
                            holder.binding.root.context,
                            holder.binding.root.context.getString(R.string.alert_overflow_amount),
                            Toast.LENGTH_SHORT
                        ).show()
                    }
                ...
                acceptProduct.setOnClickListener {
                    ...
                    if(Validador()){
                        ...
                        val product = ProductSell( holder.binding.id, item.idProducto, item.name, amount.text.toString().toLong(), earnSell)

                        holder.binding.viewmodel?.addProductSell(product, holder.binding.viewmodel?.sell?.value!!)
                        holder.binding.viewmodelP?.updateProductById(item.idProducto, item.amount - amount.text.toString().toLong())
    ...
    class ProductViewHolder(
        val binding: ListItemForSellBinding
